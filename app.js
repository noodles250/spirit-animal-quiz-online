...
// Quiz Questions Data (Will be expanded with full question set)
const QuizQuestions = [
    {
        id: 1,
        ...
        weight: 3,
        options: [
            { text: "Analyze the situation carefully before acting", animals: { owl: 3, elephant: 2, wolf: 2 } },
            { text: "Take charge and lead others through it", animals: { eagle: 3, lion: 3, tiger: 2 } },
            { text: "Adapt and find creative solutions", animals: { fox: 3, butterfly: 2, dolphin: 2 } },
            { text: "Stand strong and protect those around you", animals: { bear: 3, rhino: 2, elephant: 2 } }
        ]
    },
    {
        id: 2,
